        ...
        <div class="informacao-pagina">
            ...
            <div style="width: 30%; margin-left: auto; margin-right: auto;">
                <form action="{{ route('app.fornecedor.adicionar') }}" method="post">
                    ...
                    {{-- o operador ?? é um ternário mais simplificado, estamos dizendo no value
                         abaixo que se houver um $fornecedor->nome ele será impresso, caso contrário
                         o que tiver depois do ?? será impresso--}}
